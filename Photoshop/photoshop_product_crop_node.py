"""
Adobe Photoshop Product Crop Node

Crop images to specific dimensions using Adobe Photoshop API.
"""
...
class PhotoshopProductCropNode:
    """
    Add padding around images using Adobe Photoshop Product Crop API.

    Features:
    - Add padding with specified width/height
    - Support for pixel or percent units
    ...
    def INPUT_TYPES(cls):
        return {
            "optional": {
                ...
                "unit": (["Pixels", "Percent"], {
                    "default": "Pixels",
                    "tooltip": "Unit for width and height padding",
                }),
    ...
    def _build_debug_log(
        ...
        log = "=" * 55 + "\n"
        log += "POST /pie/psdService/productCrop\n"
        log += "-" * 55 + "\n"
        log += "Headers:\n"
    ...
    async def api_call(
        ...
        """Execute Photoshop Product Crop on image using Photoshop API."""
        ...
        try:
            ...
            submit_endpoint = ApiEndpoint(
                ...
                request_model=ProductCropRequest,
                response_model=ProductCropResponse,
            )
            ...
            poll_endpoint = ApiEndpoint(
                ...
                response_model=ProductCropJobStatus,
            )
            ...
            poll_op = PollingOperation(
                ...
                estimated_duration=20.0,  # Estimated 20s for Product Crop
                node_id=unique_id,
            )
            ...
            if not result.result or not result.result.outputs:
                ...
                raise Exception(f"No outputs returned from Photoshop Product Crop API. Check console logs or connect debug_log output for details.")
